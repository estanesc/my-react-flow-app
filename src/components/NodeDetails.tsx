...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: { width: '100%', padding: 8, borderRadius: 6, border: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.03)', color: 'var(--element-color-on)' },
  textarea: { width: '100%', padding: 8, borderRadius: 6, border: '1px solid rgba(255,255,255,0.06)', resize: 'vertical', background: 'rgba(255,255,255,0.03)', color: 'var(--element-color-on)' },
  value: { fontSize: 13, color: 'var(--element-color-on)', padding: '6px 8px', borderRadius: 6, background: 'rgba(255,255,255,0.02)' },
