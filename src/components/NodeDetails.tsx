...
const styles: Record<string, React.CSSProperties> = {
  ...
  label: { display: 'block', fontSize: 12, fontWeight: 600, marginBottom: 6, color: '#444' },
  input: { width: '100%', padding: 8, borderRadius: 6, border: '1px solid rgba(0,0,0,0.12)' },
  textarea: { width: '100%', padding: 8, borderRadius: 6, border: '1px solid rgba(0,0,0,0.12)', resize: 'vertical' },
  value: { fontSize: 13, color: '#222', padding: '6px 8px', borderRadius: 6, background: '#f7f7f7' },
  ...
  secondaryButton: { background: '#f0f0f0', color: '#111', padding: '8px 12px', border: 'none', borderRadius: 6, cursor: 'pointer' },
};
